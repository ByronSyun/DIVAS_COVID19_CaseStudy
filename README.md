...
> 💡 **Tip**: Each directory contains a comprehensive `README.md` with detailed step-by-step instructions, troubleshooting guides, and expected outputs.

## Data Requirements

⚠️ **Important**: This repository contains code and documentation only. Large data files are excluded from Git and must be generated by running the preprocessing scripts on your raw data.
